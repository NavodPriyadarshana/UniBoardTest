...
// ─────────────────────────────────────────────
// MY BOOKINGS SCREEN
// Shows all booking requests made by student.
// Student can track pending, confirmed
// and rejected booking statuses.
// ─────────────────────────────────────────────
...
class _MyBookingsScreenState
  ...
  // ─────────────────────────────────────────────
  // FETCH STUDENT BOOKINGS FROM FIRESTORE
  // ─────────────────────────────────────────────
  ...
  Widget _buildBookingCard(Map<String, dynamic> booking) {
    ...
    final String title =
        listingData['title'] ?? 'Boarding Listing';
    final String location =
        listingData['location'] ?? 'Location';
    final double price =
        (listingData['pricePerSlot'] as num? ?? 0)
            .toDouble();
    final String roomType =
        listingData['roomType'] ?? 'Room';
